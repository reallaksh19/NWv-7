...
# ── Tier A/B RSS feeds per slot ───────────────────────────────────────────────
# Tier A = direct feeds from top-tier publishers (no Google News intermediary)
# Tier B = Google News search-backed feeds as fill-in for harder-to-reach topics
SLOT_FEEDS = {
    'now': [
        # Tier A — direct RSS
        ('https://www.thehindu.com/news/national/feeder/default.rss',                'The Hindu',         'the_hindu'),
        ('https://economictimes.indiatimes.com/rssfeeds/1977021501.cms',             'Economic Times',    'economic_times'),
        ('https://feeds.feedburner.com/ndtvnews-top-stories',                        'NDTV',              'ndtv'),
        ('https://www.hindustantimes.com/feeds/rss/india-news/rssfeed.xml',          'Hindustan Times',   'hindustan_times'),
        # Tier B — Google News as supplement for breaking
        ('https://news.google.com/rss/search?q=India+breaking+news&hl=en-IN&gl=IN&ceid=IN:en',
                                                                                     'Google News',       'google_news'),
    ],
    'minus4h': [
        # Tier A
        ('https://timesofindia.indiatimes.com/rssfeeds/296589292.cms',              'Times of India',    'times_of_india'),
        ('https://www.hindustantimes.com/feeds/rss/india-news/rssfeed.xml',          'Hindustan Times',   'hindustan_times'),
        ('https://feeds.feedburner.com/ndtvnews-india-news',                         'NDTV India',        'ndtv'),
        ('https://www.thehindu.com/news/national/feeder/default.rss',               'The Hindu',         'the_hindu'),
    ],
    'minus12h': [
        # Tier A — international view
        ('https://feeds.bbci.co.uk/news/world/rss.xml',                             'BBC World',         'bbc'),
        ('https://feeds.bbci.co.uk/news/india/rss.xml',                             'BBC India',         'bbc'),
        ('https://www.thehindu.com/news/international/feeder/default.rss',           'The Hindu Intl',    'the_hindu'),
        ('https://rss.app/feeds/v1.1/_Bg5JB2jvVd0zOhwA.json',                       'Reuters India',     'reuters'),
    ],
    'minus24h': [
        # Tier A — business/markets emphasis
        ('https://economictimes.indiatimes.com/rssfeeds/1368519714.cms',             'ET Markets',        'economic_times'),
        ('https://www.moneycontrol.com/rss/latestnews.xml',                          'Moneycontrol',      'moneycontrol'),
        ('https://www.thehindubusinessline.com/news/feeder/default.rss',             'Business Line',     'business_line'),
        ('https://www.financialexpress.com/feed/',                                   'Financial Express', 'financial_express'),
    ],
}
