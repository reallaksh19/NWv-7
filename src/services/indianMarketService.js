...
export async function fetchAllMarketData() {
    ...
    const [indices, mutualFunds, ipoData, movers, sectorals, commodities, currencies, fiidii, nfo, stockCategories] = await Promise.allSettled([fetchIndices(), fetchMutualFunds(), fetchIPOData(), fetchTopMovers(), fetchSectoralIndices(), fetchCommodities(), fetchCurrencyRates(), fetchFIIDII(), fetchNFOData(), fetchStockCategories()]);
